...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="<?php echo base_url('/temp/assets/vendors/mdi/css/materialdesignicons.min.css');?>">
  <link rel="stylesheet" href="<?php echo base_url('/temp/assets/vendors/css/vendor.bundle.base.css');?>">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="<?php echo base_url('/temp/assets/vendors/flag-icon-css/css/flag-icon.min.css');?>">
  <link rel="stylesheet" href="<?php echo base_url('/temp/assets/vendors/jvectormap/jquery-jvectormap.css');?>">
  <!-- End plugin css for this page -->
  <!-- Layout styles -->
  <link rel="stylesheet" href="<?php echo base_url('/temp/assets/css/demo/style.css');?>">
  <!-- End layout styles -->
  <link rel="shortcut icon" href="<?php echo base_url('/temp/assets/images/favicon.png');?>" />
</head>
<body>
<script src="<?php echo base_url('/temp/assets/js/preloader.js');?>"></script>
